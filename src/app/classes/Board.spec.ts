...
describe('Board', () => {
  const rouletteWheelSpy: RouletteWheel = jasmine.createSpyObj(
    'RouletteWheel',
    { spin: 0 }
  )
  ...
  it('Bet PASSE win 1x', () => {
    const rouletteWheelPasseSpy: RouletteWheel = jasmine.createSpyObj(
      'RouletteWheel',
      { spin: 19 }
    )
  ...
  it('Bet MANQUE win 1x', () => {
    const rouletteWheelManqueSpy: RouletteWheel = jasmine.createSpyObj(
      'RouletteWheel',
      { spin: 1 }
    )
